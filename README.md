...
- `Salary.ipynb`: An analysis of the variables that are related to slary and job satisfaction
...
- `Salary_ML.py`: A python script that builds a Lnear Regression model to predict salary
